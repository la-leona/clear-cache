# clear-browser-and-windows-cache-v5.ps1 — 사용된 내장 함수 / 문법 설명

이 문서는 `clear-browser-and-windows-cache-v5.ps1` 에서 실제로 쓰인 PowerShell
...
- 이 스크립트 자체 도움말: `Get-Help .\clear-browser-and-windows-cache-v5.ps1 -Full`.
