...
.EXAMPLE
    powershell -ExecutionPolicy Bypass -File C:\opt\ps1\clear-browser-and-windows-cache-v3.ps1 -Preview

.EXAMPLE
    powershell -ExecutionPolicy Bypass -File C:\opt\ps1\clear-browser-and-windows-cache-v3.ps1 -Force -ClearBrowserCache

.EXAMPLE
    powershell -ExecutionPolicy Bypass -File C:\opt\ps1\clear-browser-and-windows-cache-v3.ps1 -DeepWindowsCache -Preview
#>
...
function Show-Usage {
    ...
    Write-Host '  .\clear-browser-and-windows-cache-v3.ps1 -Preview'
    Write-Host '  .\clear-browser-and-windows-cache-v3.ps1 -ClearBrowserCache'
    Write-Host '  .\clear-browser-and-windows-cache-v3.ps1 -ClearBrowserCache -ForceCloseBrowsers'
    Write-Host '  .\clear-browser-and-windows-cache-v3.ps1 -OlderThanDays 30 -IncludeWindowsUpdateCache'
    Write-Host '  .\clear-browser-and-windows-cache-v3.ps1 -DeepWindowsCache -Preview'
    Write-Host '  .\clear-browser-and-windows-cache-v3.ps1 -RebuildExplorerCache -ClearDeliveryOptimizationCache'
}
